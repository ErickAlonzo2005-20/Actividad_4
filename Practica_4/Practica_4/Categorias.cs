        ...
        private void cargarDatos()
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string queryCategoria = "SELECT CategoriaID, NombreCategoria FROM Categorias;";
                ...
                {
                    MessageBox.Show("Error al cargar datos de Categorias: " + ex.Message, "Error SQL", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
